<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="StudentProfile.aspx.cs" Inherits="AdminPanel_Student_StudentProfile" %>
            ...
            <div class="navbar-inner" style="margin-top: 70px;">
                ...
                <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <asp:HyperLink ID="HyperLink1" NavigateUrl="~/AdminPanel/Book/BookInventory.aspx" runat="server" CssClass="nav-link">
...
<asp:Content ID="Content4" ContentPlaceHolderID="cphMainArea" Runat="Server">
     <div class="row">
        <div class="col-md-12">
            <div class="card" style="width: 25rem; margin-left:30%;box-shadow: 0 0 2rem 0 rgba(136, 152, 170, .30);">
                <div style="margin-left:90px;">
                    <asp:Image ID="imgAddBook" Width="70%" ImageUrl="~/Content/img/theme/StudentProfile.png" runat="server" CssClass="card-img-top" />
                </div>
                ...
                <div class="card-body">
                    ...
                    <div style="text-align:center;">
                        <asp:HyperLink Width="40%" runat="server" ID="hlAddBook" NavigateUrl="~/AdminPanel/Student/AddStudent.aspx" CssClass="btn btn-outline-success btn-lg" Text="Add"></asp:HyperLink>
                        <asp:HyperLink Width="40%" runat="server" ID="hlEditBook"  NavigateUrl="~/AdminPanel/Student/EditStudent.aspx" CssClass="btn btn-outline-info btn-lg" Text="View"></asp:HyperLink>
                    </div>
...
<%--            <button onclick="AddBook()" style="padding:60px; float:right;" type="button" class="btn btn-outline-success btn-lg"></button>--%>
    ...
    <span class="text-light">*Note: In View option Admin can edit the list of the Student.</span>
</asp:Content>
