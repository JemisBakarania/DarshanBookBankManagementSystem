<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="MasterBookUpdate.aspx.cs" Inherits="AdminPanel_Book_MasterBookUpdate" %>
...
<asp:Content ID="Content8" ContentPlaceHolderID="cphMainArea" Runat="Server">
       ...
       <%-- <div class="row" style="padding: 20px;">
        ...
        <div class="row" style="padding: 20px;">
            <div class="co-md-6" style="margin-left: 150px; text-align: center;">
                <div class="form=group">
                    <asp:Button ValidationGroup="vgAdd" ID="btnAdd" Width="300%" CssClass="btn btn-outline-warning" Text="Update" runat="server"/>
                </div>

            </div>
            <div class="co-md-6" style="margin-left: 400px; text-align: center;">
                <div class="form=group">
                    <asp:Button ID="btnCancel" Width="300%" CssClass="btn btn-outline-danger" Text="Cancel" runat="server" />
                </div>
    ...
    <span class="text-light">*Note: If Admin wants to update book copy one should goto the previous page.</span>
</asp:Content>
